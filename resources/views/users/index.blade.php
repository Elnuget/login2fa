                                    ...
                                    <td class="py-3 px-6 text-center flex justify-center">
                                        <a href="{{ route('users.edit', $user->id) }}" 
                                           class="flex items-center mr-2 text-blue-500 hover:text-blue-600">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487a2.25 2.25 0 0 1 3.181 3.182l-12.62 12.62-4.03.86a.75.75 0 0 1-.883-.884l.86-4.03 12.62-12.62z" />
                                            </svg>
                                            Editar
                                        </a>
                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="inline">
                                            ...
                                            <button type="submit" class="flex items-center text-red-500 hover:text-red-600">
                                                <!-- Icono de "eliminar" -->
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 9.75L4.5 9.75m15 0l-.628 10.098A2.25 2.25 0 0 1 16.628 22.5H7.372a2.25 2.25 0 0 1-2.244-2.652L4.5 9.75m15 0L15.75 4.5m-7.5 0L4.5 9.75m3.75-5.25h7.5m-7.5 0A2.25 2.25 0 0 1 8.25 4.5h7.5A2.25 2.25 0 0 1 18 6.75m-9.75-2.25L12 3" />
                                                </svg>
                                                Eliminar
                                            </button>
                                        </form>
