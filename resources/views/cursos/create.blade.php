            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('cursos.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombre" id="nombre" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-300 focus:ring focus:ring-blue-200 dark:focus:ring-blue-600" value="{{ old('nombre') }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-300 focus:ring focus:ring-blue-200 dark:focus:ring-blue-600">{{ old('descripcion') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="precio" id="precio" step="0.01" class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-300 focus:ring focus:ring-blue-200 dark:focus:ring-blue-600" value="{{ old('precio') }}" required>
                    </div>
